#
#  Be sure to run `pod spec lint MapQuestService.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "MapQuestService is a network service that you can use to retrieve locations from MapQuest's SDK."
